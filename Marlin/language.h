...
#define PROTOCOL_VERSION "1.0"
	...
	#define FIRMWARE_URL "https://reprap.org"
#endif
...
#define MSG_ERR_LONG_EXTRUDE_STOP			" защита превышения длинны экструзии"
	...
	// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME " Benvenuto! ;)"
	#define MSG_SD_INSERTED          "SD Card inserita"
	#define MSG_SD_REMOVED           "SD Card rimossa"
	#define MSG_MAIN                 "Menu principale"
	#define MSG_AUTOSTART            "Autostart"
	#define MSG_DISABLE_STEPPERS     "Disabilita Motori"
	#define MSG_AUTO_HOME            "Home assi x,y,z"
	#define MSG_SET_ORIGIN           "Imposta l'origine"
	#define MSG_PREHEAT_PLA          "Riscalda per PLA"
	#define MSG_PREHEAT_PLA_SETTINGS "Config. temp. PLA"
	#define MSG_PREHEAT_ABS          "Riscalda per ABS"
	#define MSG_PREHEAT_ABS_SETTINGS "Config. temp. ABS"
	#define MSG_COOLDOWN             "Rafredda tutto"
	#define MSG_EXTRUDE              "Estrudi"
	#define MSG_RETRACT              "Ritrai"
	#define MSG_MOVE_AXIS            "Muovi Asse"
	#define MSG_SPEED                "Velcita'"
	#define MSG_NOZZLE               "Testina1 temp."
	#define MSG_NOZZLE1              "Testina2 temp."
	#define MSG_NOZZLE2              "Testina3 temp."
	#define MSG_BED                  "Piano di stampa"
	#define MSG_FAN_SPEED            "Ventola"
	#define MSG_FLOW                 "Flusso"
	#define MSG_CONTROL              "Impostazioni"
	#define MSG_MIN                  " \002 Min:"
	#define MSG_MAX                  " \002 Max:"
	#define MSG_FACTOR               " \002 Fact:"
	#define MSG_AUTOTEMP             "Autotemp"
	...
	#define MSG_STORE_EPROM          "Salva config."
	#define MSG_LOAD_EPROM           "Carica config."
	#define MSG_RESTORE_FAILSAFE     "riprist. default"
	#define MSG_REFRESH              "Aggiorna"
	#define MSG_WATCH                "Monitor stampante"
	#define MSG_PREPARE              "Preparazione"
	#define MSG_TUNE                 "tuning real-time"
	#define MSG_PAUSE_PRINT          "Pausa"
	#define MSG_RESUME_PRINT         "Riprendi"
	#define MSG_STOP_PRINT           "Arresta la Stampa"
	#define MSG_CARD_MENU            "SD Card Menu"
	#define MSG_NO_CARD              "SD Card assente"
	#define MSG_DWELL                "prendi un caffe'..."
	#define MSG_USERWAIT             "In attesa ^_^"
	#define MSG_RESUMING             "Riprendi Stampa"
	#define MSG_NO_MOVE              "Nessun Movimento."
	#define MSG_KILLED               ">>TERMINATO<< "
	#define MSG_STOPPED              ">>>STOP<<< "
	...
	#define MSG_SD_VOL_INIT_FAIL     "Non posso montare il volume"
	...
	#define MSG_ERR_COLD_EXTRUDE_STOP " Evitata estrusione fredda"
	#define MSG_ERR_LONG_EXTRUDE_STOP " Evitata estrusione troppo lunga"
